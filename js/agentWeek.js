  ...
  try {
    ...
    data.forEach((obj) => {
      if (
        ...
        datosAgregados[obj.Closer].puntajeTotal += parseNumericalValueWe(
          obj.DealsThisWeek
        );
      }
    });
...
function showData() {
  const tableBody = document.getElementById("dataAgentWeed");
  let htmlContent = "";
  ...
  for (let i = 0; i < displayData.length; i++) {
    ...
    <div class="sales">
      ...
      <div class="middle">
          ...
          <div class="progress">
              <svg>
                  <circle id="weeklyCircle" cx="40%" cy="45%" r="35" pathlength="100" style="stroke-dasharray: ${porcentaje.toFixed(2)} 100;"></circle>
              </svg>
              <div class="number">
